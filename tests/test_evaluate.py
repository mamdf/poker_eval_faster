...
ps_eval = [
    [['Ac', 'Ad', 'Ah', 'As', 'Ts', 'Ks', 'Qs'], [946.0, 0.0, 44.0]],
    [['2c', '2d', '5d', '8c', '9c', 'Tc', 'Jc'], [666.0, 0.0, 324.0]],
    [['Ac', 'Kc', '4c', '4d', '4h', '4s', 'Qc'], [861.0, 64.5, 0.0]],
    [['Jc', 'Tc', '3c', '3d', '5c', '5d', '9s'], [226.0, 34.5, 695.0]],
    [['Ac', 'Ad', 'Ts', 'Ks', 'Qs', '2s'], [19590.0, 3049.5, 19851.0]],
    [['Ac', 'Ad', 'Ts', 'Ks', 'Qs'], [732043.0, 25279.0, 287589.0]]
]


@pytest.mark.parametrize('cards, expected', ps_eval)
