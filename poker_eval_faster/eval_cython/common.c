...
{
    "distutils": {
        "name": "poker_eval_faster.eval_cython.common",
        "sources": [
            "poker_eval_faster/eval_cython/common.pyx"
        ]
    },
    "module_name": "poker_eval_faster.eval_cython.common"
}
END: Cython Metadata */
...
#define __PYX_HAVE__poker_eval_faster__eval_cython__common
#define __PYX_HAVE_API__poker_eval_faster__eval_cython__common
/* Early includes */
#include <stdint.h>
#include "pythread.h"
#include <string.h>
...
#define __Pyx_MODULE_NAME "poker_eval_faster.eval_cython.common"
extern int __pyx_module_is_main_poker_eval_faster__eval_cython__common;
int __pyx_module_is_main_poker_eval_faster__eval_cython__common = 0;

/* Implementation of "poker_eval_faster.eval_cython.common" */
...
#define __pyx_n_u_id __pyx_string_tab[66]
#define __pyx_n_u_import __pyx_string_tab[67]
...
#define __pyx_n_u_obj __pyx_string_tab[79]
...
#define __pyx_n_u_pyx_unpickle_Enum __pyx_string_tab[86]
...
#define __pyx_n_u_register __pyx_string_tab[92]
...
#define __pyx_n_u_struct __pyx_string_tab[102]
#define __pyx_n_u_test __pyx_string_tab[103]
#define __pyx_n_u_unpack __pyx_string_tab[104]
...
#define __pyx_kp_b_Pyx_memviewslice_handdat __pyx_string_tab[108]
#define __pyx_kp_b_uint32_t_uint32_t___Pyx_memviews __pyx_string_tab[109]
...
*/
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_2 = __Pyx_PySequence_Multiply(__pyx_mstate_global->__pyx_tuple[0], __pyx_v_self->view.ndim); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 583, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_r = __pyx_t_2;
    __pyx_t_2 = 0;
    goto __pyx_L0;
...
/* "poker_eval_faster/eval_cython/common.pyx":7
 * 
 * 
...
static uint32_t __pyx_f_17poker_eval_faster_11eval_cython_6common_fold_cards(uint32_t __pyx_v_start_eval, __Pyx_memviewslice __pyx_v_cards, int __pyx_v_start_idx, int __pyx_v_end_idx) {
  uint32_t __pyx_v_p;
  int __pyx_v_i;
  uint32_t __pyx_r;
  int __pyx_t_1;
  ...
  /* "poker_eval_faster/eval_cython/common.pyx":8
 * 
 * cdef stdint.uint32_t fold_cards(stdint.uint32_t start_eval, int[:] cards, int start_idx, int end_idx) noexcept nogil:
 *     cdef stdint.uint32_t p = start_eval             # <<<<<<<<<<<<<<
 *     cdef int i
...
*/
  __pyx_v_p = __pyx_v_start_eval;

  /* "poker_eval_faster/eval_cython/common.pyx":10
 *     cdef stdint.uint32_t p = start_eval
 *     cdef int i
 *     for i in range(start_idx, end_idx):             # <<<<<<<<<<<<<<
 *         p = handdat[p + cards[i]]
...
*/
  ...
  for (__pyx_t_3 = __pyx_v_start_idx; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "poker_eval_faster/eval_cython/common.pyx":11
 *     cdef int i
 *     for i in range(start_idx, end_idx):
 *         p = handdat[p + cards[i]]             # <<<<<<<<<<<<<<
 *     return p
*/
    if (unlikely(!__pyx_v_17poker_eval_faster_11eval_cython_4main_handdat.memview)) { __Pyx_RaiseUnboundLocalErrorNogil("handdat"); __PYX_ERR(0, 11, __pyx_L1_error) }
    __pyx_t_4 = __pyx_v_i;
    __pyx_t_5 = (__pyx_v_p + (*((int *) ( /* dim=0 */ (__pyx_v_cards.data + __pyx_t_4 * __pyx_v_cards.strides[0]) ))));
    __pyx_v_p = (*((uint32_t const  *) ( /* dim=0 */ (__pyx_v_17poker_eval_faster_11eval_cython_4main_handdat.data + __pyx_t_5 * __pyx_v_17poker_eval_faster_11eval_cython_4main_handdat.strides[0]) )));
  }

  /* "poker_eval_faster/eval_cython/common.pyx":12
 *     for i in range(start_idx, end_idx):
 *         p = handdat[p + cards[i]]
 *     return p             # <<<<<<<<<<<<<<
*/
...
*/
  ...
  __pyx_L1_error:;
  __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
  __Pyx_WriteUnraisable("poker_eval_faster.eval_cython.common.fold_cards", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __Pyx_PyGILState_Release(__pyx_gilstate_save);
  __pyx_L0:;
  return __pyx_r;
...
static PyType_Spec __pyx_type___pyx_array_spec = {
  "poker_eval_faster.eval_cython.common.array",
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "poker_eval_faster.eval_cython.common.""array", /*tp_name*/
...
static PyType_Spec __pyx_type___pyx_MemviewEnum_spec = {
  "poker_eval_faster.eval_cython.common.Enum",
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "poker_eval_faster.eval_cython.common.""Enum", /*tp_name*/
...
static PyType_Spec __pyx_type___pyx_memoryview_spec = {
  "poker_eval_faster.eval_cython.common.memoryview",
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "poker_eval_faster.eval_cython.common.""memoryview", /*tp_name*/
...
static PyType_Spec __pyx_type___pyx_memoryviewslice_spec = {
  "poker_eval_faster.eval_cython.common._memoryviewslice",
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "poker_eval_faster.eval_cython.common.""_memoryviewslice", /*tp_name*/
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  /*--- Function export code ---*/
  {
    ...
    __Pyx_GOTREF(__pyx_t_1);
    const char * __pyx_export_signature = __Pyx_PyBytes_AsString(__pyx_mstate_global->__pyx_kp_b_uint32_t_uint32_t___Pyx_memviews);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (unlikely(!__pyx_export_signature)) __PYX_ERR(0, 1, __pyx_L1_error)
    #endif
    const char * __pyx_export_name = __pyx_export_signature + 50;
    void (*const __pyx_export_pointers[])(void) = {(void (*)(void))&__pyx_f_17poker_eval_faster_11eval_cython_6common_fold_cards, (void (*)(void)) NULL};
...
__Pyx_RefNannySetupContext("PyInit_common", 0);
  ...
  if (__pyx_module_is_main_poker_eval_faster__eval_cython__common) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name_2, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "poker_eval_faster.eval_cython.common")) {
      if (unlikely((PyDict_SetItemString(modules, "poker_eval_faster.eval_cython.common", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  /* "poker_eval_faster/eval_cython/common.pyx":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init poker_eval_faster.eval_cython.common", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init poker_eval_faster.eval_cython.common");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{2},{68},{35},{54},{37},{60},{24},{52},{26},{34},{29},{33},{45},{22},{15},{179},{37},{30},{32},{1},{1},{1},{1},{1},{8},{5},{6},{15},{23},{25},{7},{6},{2},{6},{35},{9},{30},{50},{8},{20},{32},{22},{30},{37},{5},{8},{20},{8},{15},{3},{15},{4},{1},{9},{17},{18},{5},{8},{15},{6},{9},{5},{5},{6},{7},{12},{2},{10},{5},{5},{8},{8},{7},{4},{10},{4},{8},{4},{7},{3},{4},{3},{12},{14},{11},{10},{19},{14},{12},{10},{17},{13},{8},{12},{10},{12},{19},{5},{4},{5},{4},{4},{6},{8},{6},{6},{6},{1},{26},{60},{1}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (1001 bytes) */
const char* const cstring = "BZh91AY&SYN>7\030\000\000o\337\200@\000B\347\\W\277#\333\000\277\377\377\360P\004\014R\365c6\324\325\2654%5\t\202S\364C\022\233\324\215\251\246#M4\364#\324\3204\030\000\000\000\r\000\000\000\000\r4\321\t\221\rF\2325=M\r\000\r\0004\323!\200\000\000\000\320\000\000\000\000\224\322\022\236\310\211\351\241\244=@4\000\006\200hu\307\271\303wy\236\204\007\372?\222\360\374\352\245\016w\307'q\2769r\272\234\324\035i$\215^G\232\3560\037\265\355\227\2050\035D}\254\372\035\030\364\377\2725\213n\345I\230\300w\374m\300\240\235\021~\352\243\270H\357\325`A[t\270\201\226\345\341Y=\371W7\305\213\252\210\332\213\244\302\263Y\215\312\266\317\024\336x\001\277\227\262\360\300g\256\300\366N\377x\024\326N\315\225RkS\264\231\361\355\351\373D\333\264;\272\2507c\243\273\226\310n4\216wi\347\177\010\277\213\245k?\013Ya}T\001\216\337,_\034\215X\007\257Z\014\022\304VY\227u\033\254\317OfBgT\350\201\034=n\201\266}\221k\020\361\221\321\220 \350\354\344\220\201i\"e\301\241\304t\236\234\342\222\316\316\213%5u\377\254\013\036_M\233\275J\031w\362\205\203\277\247\022\266\010@9c\000\231-\006{\357\270$n\033\331\346*\331\325\010\337\007\304\365&\252\212&\273\314\310\232x\004\000x{W\
T\235/H&\364\346%\255\006:\304J\201\001\023m\235\340w~\240l9P\346\"\006-Z/tA\335\n\307\241\315\305\314\253\333\261\234\376]\373\314\313\317/\310\003\344Y`\332\030\316G6\037\nO4\352C\343\017z\376\316)\236\210\376\032\232r\020\022j\334q\2020\n\217\362\035\327R\324\362vq\371\253\266V\005\241G\212%0\364no\242\367\002\007\215Y\352\265\2719\323\2628u\260\267\377^>J\350\326\272,y\271e\337\030\272\2206m\232z\244\002\031F\336\027\016\245\215\306i.]\356G\254\240\314\356;\323\315/\364\356\225\266BD\353\006]}!\245\022\333jX)\262\265\025\032b\270F+wN{\354\032\027\\\301f/\367\366\246\017\257}Q\305\3535\021\331s1/\366\237W\3533\263\332\373h\332\r \330\310\352\242\227\377\261\333\325)1\346\013d\371\341\341n\265\272\367\336M\331e\245\276\034\366x>B\204\352\023\330\371\223\207\007\376V9\030\026\r/OrFC\216QU\227\304Zg6(V\304\246\324\321\330p\021\036\345\323\005V\016bK\332\360Z\233G\003M\201\026+\311\224\025\t+@\350$!#\246\216C\035\333hpJ1\r^o2\3320\3522\317\236\222\360""\271\010\006\345,\236Q&\027\2772\367\275}s\017\225\0325r+\\8r\333\310H\343#\332\352\361\033\364xzC\010x\363\223\022$\023`NqRj\002/FON\nk\366\226\315c\256c\377\232!\210\331\312hV\r\2233\217\210\177\037\216~\273v\207J\214oU\373\236\360$\236g\253\313\354l\201\367bn\\\306\325\240\024&x\006\013k\326`\263g\030g\3661R\353\273\360\200\345\204=\236r\211xR\025\356\013\226\225\340E\265u\202v\030wY\345\274\357z\2309k\177Jop/YxT\027\312\217?\250B\027G\353\212^{_A\252\245\275.\337\014\321[P\230l\376\374\017Ev\263\237";
    PyObject *data = __Pyx_DecompressString(cstring, 902, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (1823 bytes) */
const char* const bytes = ": All dimensions preceding dimension %d must be indexed and not slicedBuffer view does not expose stridesCan only create a buffer that is contiguous in memory.Cannot assign to read-only memoryviewCannot create writable memory view from read-only memoryviewCannot index with type 'Cannot transpose memoryview with indirect dimensionsDimension %d is not directEmpty shape tuple for cython.arrayIndex out of bounds (axis %d)Indirect dimensions not supportedInvalid mode, expected 'c' or 'fortran', got Invalid shape in axis <MemoryView of Note that Cython is deliberately stricter than PEP-484 and rejects subclasses of builtin types. If you need to pass subclasses then set the 'annotation_typing' directive to False.Out of bounds on buffer access (axis Step may not be zero (axis %d)Unable to convert item to object.>')?add_note and  at 0xcollections.abc<contiguous and direct><contiguous and indirect>disableenablegc (got got differing extents in dimension isenableditemsize <= 0 for cython.arrayno default __reduce__ due to non-trivial __cinit__ object><strided and direct><strided and direct or indirect><strided and indirect>unable to allocate array data.unable to allocate shape and strides.ASCIIEllipsis__Pyx_PyDict_NextRefSequenceView.MemoryViewabcallocate_bufferbasec__class____class_getitem__cline_in_tracebackcount__dict__dtype_is_objectencodeenumerateerrorflagsformatfortran__getstate__id__import__indexitemsitemsize__main__memviewmode__module__name__name__ndim__new__objpackpop__pyx_capi____pyx_checksum__pyx_state__pyx_type__pyx_unpickle_Enum__pyx_vtable____qualname____reduce____reduce_cython____reduce_ex__register__set_name__setdefault__setstate____setstate_cython__shapesizestartstepstopstruct__test__unpackupdatevaluesx__Pyx_memviewslice\000handdatuint32_t (uint32_t, __Pyx_memviewslice, int, int)\000fold_cardsO";
    PyObject *data = NULL;
